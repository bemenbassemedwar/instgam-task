...
class SecureCacheHelper implements CacheHelper {
  ...
  Future<Set<String>> getKeys() =>
      db.readAll().then<Set<String>>((r) => r.keys.toSet());
  ...
  @override
  Future<String?> readStringOrNull(String key) => db.read(key: key);

  @override
  Future<String> readStringOr(String key, String fallback) async =>
  ...
  /// * read the value of the key from the cache
  @override
  Future<bool?> readBoolOrNull(String key) async =>
      bool.tryParse(await readStringOrNull(key) ?? '', caseSensitive: false);

  @override
  Future<bool> readBoolOr(String key, bool or) async =>
  ...
  Future<void> writeBool(String key, bool value) =>
      db.write(key: key, value: value.toString());

  /// * read the value of the key from the cache
  @override
  Future<Map<dynamic, dynamic>?> readMapOrNull(String key) async {
  ...
  Future<void> writeMap(String key, Map<dynamic, dynamic> value) =>
      db.write(key: key, value: jsonEncode(value));
}
